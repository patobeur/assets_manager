...
<div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
    ...
    <div class="flex space-x-2 mt-4 md:mt-0">
        <a href="?page=sections&action=create" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded text-sm">
            <?php echo t('add_section'); ?>
        </a>
    </div>
</div>
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">
                            <?php echo t('delete_section'); ?>
                        </h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                <?php echo t('confirm_delete_section'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <a href="?page=sections&action=edit&id=<?php echo $section['id']; ?>" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" title="<?php echo t('edit_section'); ?>">
                            ...
                            <button data-id="<?php echo $section['id']; ?>" class="delete-btn w-4 mr-2 transform hover:text-red-500 hover:scale-110" title="<?php echo t('delete_section'); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
