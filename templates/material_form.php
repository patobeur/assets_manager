...
<h1 class="text-3xl font-bold mb-6"><?php echo $is_edit ? 'Edit Material' : 'Add Material'; ?></h1>
    ...
    <form action="?page=materials&action=<?php echo $is_edit ? 'edit&id=' . $material['id'] : 'create'; ?>" method="post">
        ...
        <div class="mb-4">
            ...
            <select id="status" name="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                ...
                <option value="loaned" <?php echo $material['status'] === 'loaned' ? 'selected' : ''; ?>>Loaned</option>
                <option value="maintenance" <?php echo $material['status'] === 'maintenance' ? 'selected' : ''; ?>>Maintenance</option>
            </select>
        </div>
        <div class="mb-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="?page=materials" class="text-gray-600">Cancel</a>
        </div>
    </form>
</div>